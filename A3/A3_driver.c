...
#include<stdio.h>
#include<stdlib.h>
#include"ingredient_graph_1008124405.c"
...
int main()
{
   ...
   printf("\n ****** Related with restrictions, 'quinoa', 'tomato juice', k_source=2, k_dest=2 - Updated;\n");
   head=related_with_restrictions("medium shrimp","fresh breadcrumbs",3,2);
   print_ingredients(head);
   head=deleteList(head);

    printf("\n ****** Related with restrictions, 'quinoa', 'tomato juice', k_source=2, k_dest=2 - Updated;\n");
   head=related_k_dist(head, "medium shrimp", 3, 0);
   print_ingredients(head);
   head=deleteList(head);
